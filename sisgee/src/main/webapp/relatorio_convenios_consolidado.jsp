...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="ValidaRelatorioConveniosConsolidadoServlet" method="POST" >
                <fieldset class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4" style="margin-left: 10px;">
                            ...
                            <label for="Data de Registro Inicio"><fmt:message key="br.cefetrj.sisgee.relatorio.relatorio_consolidado.lbl_data_inicio" /></label>
                            <input type="text" class="form-control" id="dataInicio"  name="registroInicio" value="${ param.registroInicio }">
                            <br>
                        ...
                        <div class="form-group col-md-4" style="margin-left: 10px;">
                            <label for="Data de Registro Fim"><fmt:message key="br.cefetrj.sisgee.relatorio.relatorio_consolidado.lbl_data_termino" /></label>

                            <input type="text" class="form-control " id="dataFim"   name="registroFim" value="${ param.registroFim }">
                            <br>
